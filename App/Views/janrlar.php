            ...
            <div class="col-10">
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">ID</th>
                            <th scope="col">Janr Nomi</th>
                            <th scope="col">Janrlar soni</th>
                            <th>Edit</th>
                            <th>Delete</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        foreach ($muallif as $m) { ?>
                            <tr>
                                    ...
                                    <div class="modal fade" id="editModal<?= $m['id'] ?>" aria-labelledby="editModalLabel<?= $m['id'] ?>" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="/updatejanr" method="post">
                                                        <div class="mb-3">
                                ...
                                <td>
                                    <form action="/deletejanr" method="post">
                                        <input type="hidden" name="id" value="<?= $m['id'] ?>">
